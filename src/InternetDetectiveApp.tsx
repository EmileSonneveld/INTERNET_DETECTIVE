...
class InternetDetectiveApp extends React.Component<IAppProps, IAppState> {
...
function render() {
	React.render(
		<InternetDetectiveApp model={model}/>,
		document.getElementsByClassName('InternetDetectiveApp')[0]
	);
}
